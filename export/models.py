...
class Assets(models.Model):
    ...
    Property_plant_and_equipment = models.DecimalField(decimal_places=4, max_digits=15, db_column='Property, plant and equipment')
    Exploration_for_and_evaluation_of_mineral_resources = models.DecimalField(decimal_places=4, max_digits=15, db_column='Exploration for and evaluation of mineral resources')
    ...
    Investment_in_affiliates = models.DecimalField(decimal_places=4, max_digits=15, db_column='Investment in affiliates')
    Non_current_financial_assets = models.DecimalField(decimal_places=4, max_digits=15, db_column='Non-current financial assets')
    Non_current_loans_and_receivables = models.DecimalField(decimal_places=4, max_digits=15, db_column='Non-current loans and receivables')
    Deferred_income_tax = models.DecimalField(decimal_places=4, max_digits=15, db_column='Deferred income tax')
    Non_current_deferred_charges_and_accruals = models.DecimalField(decimal_places=4, max_digits=15, db_column='Non-current deferred charges and accruals')
    Non_current_derivative_instruments = models.DecimalField(decimal_places=4, max_digits=15, db_column='Non-current derivative instruments')
    Other_non_current_assets = models.DecimalField(decimal_places=4, max_digits=15, db_column='Other non-current assets')
    Inventories = models.DecimalField(decimal_places=4, max_digits=15, db_column='Inventories')
    Current_intangible_assets = models.DecimalField(decimal_places=4, max_digits=15, db_column='Current intangible assets')
    ...
    Loans_and_other_receivables = models.DecimalField(decimal_places=4, max_digits=15, db_column='Loans and other receivables')
    Financial_assets = models.DecimalField(decimal_places=4, max_digits=15, db_column='Financial assets')
    Cash_and_cash_equivalents = models.DecimalField(decimal_places=4, max_digits=15, db_column='Cash and cash equivalents')
