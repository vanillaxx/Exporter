...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='company',
            name='ekd_class_id',
            field=models.ForeignKey(blank=True, db_column='EKDClassID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.EkdClass'),
        ),
        migrations.AddField(
            model_name='company',
            name='ekd_section_id',
            field=models.ForeignKey(blank=True, db_column='EKDSectionID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.EkdSection'),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('company_id', 'period_end', 'interval'), name='stock_company_date_interval_unique'),
        ),
        migrations.AddConstraint(
            model_name='financialratios',
