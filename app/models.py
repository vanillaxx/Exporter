...
class DuPontIndicators(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['period_start', 'period_end', 'company_id'],
                                    name='dupont_indicators_company_date_unique')
        ]
...
class FinancialRatios(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['period_start', 'period_end', 'company_id'],
                                    name='financial_ratios_company_date_unique')
        ]
...
class StockQuotes(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['company_id', 'date', 'interval'],
